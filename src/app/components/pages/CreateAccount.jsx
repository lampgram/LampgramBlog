      ...
      return <div className="row">
        <div className="column">
          ...
          <div className="callout alert">
            <p>Membership to Lampgram.com/blog is now under invitation only because of unexpectedly high sign up
              rate.</p>
          </div>
        </div>
      </div>;
      ...
      return <div className="row">
        <div className="column">
          ...
          <div className="callout alert">
            ...
            <p>We will be unable to create your Lampgram account with this browser.</p>
      ...
      return <div className="row">
        <div className="column">
          ...
          <div className="callout alert">
            ...
            <p>Please note that Lampgram can only register one account per verified user.</p>
          </div>
        </div>
      </div>;
    }
        ...
        <div className="column">
          ...
          <div className="callout alert">
            <p>It looks like your sign up request is not approved yet or you already created an
              account.<br/>
              Please try again later or contact <a href="mailto:lampgram@gmail.com">lampgram@gmail.com</a> for
    ...
    return (
      <div>
        <div className="CreateAccount row">
          <div className="column">
            <h4>Please read the Lampgram Rules and fill in the form below to create your Lampgram account</h4>
            {/*<Progress tabIndex="0" value={95} max={100} />*/}
            {showRules ? <div className="CreateAccount__rules">
              <p>
                The first rule of Lampgram is: Do not lose your password.<br/>
                The second rule of Lampgram is: Do <strong>not</strong> lose your password.<br/>
                The third rule of Lampgram is: We cannot recover your password, or your account if you
                ...
                access to an account without knowing the password. Lampgram is a
              ...
              <a className="CreateAccount__rules-button" href="#"
                 onClick={() => this.setState({showRules: true})}>Lampgram
                Rules &nbsp; &raquo;</a>
            </div>}
            <br/>
