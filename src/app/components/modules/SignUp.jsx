  ...
  render() {
      ...
      return <div className="row">
        <div className="column">
          <div className="callout alert">
            <p>Due to server maintenance we are running in read only mode. We are sorry for the
              inconvenience.</p></div>
        </div>
      </div>;
    }
    ...
    return <div className="SignUp">
      <div className="row">
        <div className="column">
          <h3>Sign Up</h3>
          <p>Lampgram funds each new account an intial fund as Lampgram Power; to prevent
      ...
      <div className="row">
        <div className="column">
          ...
          {this.state.waiting_list ? <AddToWaitingList/> :
            <a href="#" onClick={() => this.setState({waiting_list: true})}>
      ...
      <div className="row">
        <div className="column">
          <br/>
          <p className="secondary">By verifying your account you agree to the Lampgram <a href="/tos.html"
                                                                                       target="_blank">terms
            and conditions</a>.</p>
        </div>
      </div>
